				...
				<div className="flex justify-between mb-10">
					<div className="page-title">
						...
						<ul className="text-tiny font-medium flex items-center space-x-3 text-text3">
							...
							<li className="breadcrumb-item text-muted">Coupon List</li>
						</ul>
					</div>
					<div className="">
						<Link to={'/add-coupon'} className="tp-btn px-5 py-2">
							Add Coupon
						</Link>
					</div>
				</div>
					...
					<div className="overflow-scroll 2xl:overflow-visible">
						<div className="w-[1500px] xl:w-full">
										...
										{coupons?.map((coupon, index) => (
											...
											>
													...
													<span
														className={`${
															coupon.status === 'Scheduled'
																...
																? 'text-green-500'
																: 'text-red-500'
														} text-[11px] px-3 py-1 rounded-md leading-none bg-success/10 font-medium text-end`}
													>
														{coupon.status}
													</span>
												</td>
												...
												<td className="px-3 py-3 text-end">
													{formatDateString(coupon.startTime)}
												</td>
												<td className="px-3 py-3 text-end">
													{formatDateString(coupon.endTime)}
												</td>
							...
							<div className="flex justify-between items-center flex-wrap mx-8">
								<p className="mb-0 text-tiny">Showing 10 Coupon of 120</p>
