							...
							{data.length > 0 &&
								data?.map((product) => {
									return (
										<div
											key={product._id}
											className="rounded-md bg-white border-gray border"
										>
													...
													<div className="flex flex-col items-center justify-center space-y-2">
														<div className="relative">
															...
															{showEditTooltip === product._id && (
																<div className="flex items-center z-50 absolute right-full translate-y-1/2 bottom-1/2 mr-1 mb-[2px]">
																	...
																	<div className="w-[6px] h-[6px] -ml-[3px] rotate-45 bg-slate-800"></div>
																</div>
															)}
														</div>
														<div className="relative">
